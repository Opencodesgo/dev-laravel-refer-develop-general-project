...
//定义 App dir
const APP_DIR_WEB = 'web';		#APP所属主WEB目录，根据实际需要改，常用有web、web_h5、web_api、web_bi
#const APP_DIR_NAME = 'apps';	#APP目录名称，一般不需要改，这里加s，以便于子目录app区分
#const APP_DIR2 = APP_DIR_WEB.'/'.APP_DIR_NAME;		#APP路径，示例 'web/apps'

//var_dump(APP_DIR2);exit;
...
require __DIR__.'/../../fra_sys/lar_vendor/autoload.php';		#上2层进行加载
